...
def sign_up_page():
    ...
    with ui.card().style('align-self: center; align-items: center; font-family: "Times New Roman";').classes('gap-y-7'):
        ...
        sign_up_button = ui.button(text = 'Sign Up', on_click = lambda: su.add_sign_up_data_to_db(first_name_input, last_name_input, username_input, email_input, password_input))
