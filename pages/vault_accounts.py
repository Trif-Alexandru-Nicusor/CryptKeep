...
def vault_accounts_page():
    ...
    with ui.card().style('width: 100%; font-family: Times New Roman'):
        ...
        with ui.row().style('align-self: center'):
            ...
            va_download_button = ui.button(icon = 'download')
            va_download_button.props('color=transparent')
            va_download_button.tooltip(text = 'Download the account/s selected.')
            ...
            va_logs_button.props('color=transparent')
        ...
        with ui.scroll_area().style('height: 435px;'):
            ...
            va_table.props('data-ag-theme-mode=dark')