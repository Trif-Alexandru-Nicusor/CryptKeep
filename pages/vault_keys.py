...
def vault_keys_page():
    ...
    with ui.card().style('width: 100%').style('font-family: Times New Roman'):
        ...
        with ui.row().style('align-self: center'):
            ...
            vk_hide_unhide_button = ui.button(icon = 'visibility', on_click = lambda: globals.global_hide_unhide_things(vk_hide_unhide_button, globals.vk_rows_hidden, globals.vk_rows_unhidden, vk_table, vk_logs, 'vk'))
            ...
            with ui.dialog() as dialog, ui.card().style('font-family: Times New Roman'):
                ...
                vk_add_key_button = ui.button(text = 'Add Key', icon = 'add', on_click = lambda: vk.vk_add_new_key(vk_name_input, vk_key_input, vk_table, globals.vk_rows_hidden, globals.vk_rows_unhidden, vk_logs))
            ...
            vk_remove_key_s_button = ui.button(icon = 'remove', on_click = lambda: globals.global_remove_data_from_tables(vk_table, 'vk', globals.vk_rows_hidden, globals.vk_rows_unhidden, vk_logs))
        ...
        with ui.scroll_area().style('height: 435px'):
            vk_table = ui.aggrid(options = {'columnDefs': vk_columns, 'rowData': globals.vk_rows_hidden, 'rowSelection': 'multiple', 'pagination': True,
